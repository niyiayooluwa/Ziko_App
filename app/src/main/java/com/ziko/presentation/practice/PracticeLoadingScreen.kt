...
fun PracticeLoadingScreen(
    ...
    val textPart = lesson.takeWhile {it.isLetter()}.replaceFirstChar { it.uppercase() }
    val numPart = lesson.takeLastWhile {it.isDigit()}
    val lessonId = "$textPart $numPart"
    ...
    LaunchedEffect(Unit) {
        ...
        navController.navigate(TODO()) { popUpTo("route") { inclusive = true } }
    }
        ...
        Box (
            ...
            Column (
                ...
                Column(
                    ...
                    Text(
                        text = "You have completed $lessonId.You are ready\nfor a bigger challenge.",
